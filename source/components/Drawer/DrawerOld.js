...
import { Platform, I18nManager, View, TouchableOpacity, Image , Text} from 'react-native';
...
import SelectCity from '../AdvanceSearch/SelectCity';
...
const DrawerComp = createDrawerNavigator({
  ...
  {
    order: [ 'Packages','Language', 'EventsTabs','ReviewsCon', 'ListingPostTabCon','SelectCity','SearchingScreen', 'Home', 'ListingTabCon', 'Dashboard', 'AboutUs', 'ContactUs', 'blogStack', 'SavedListing', 'Categories','PublicEvents'],
